!(function (e, t) {
        ...
        if (I.isFormData(e) && I.isFunction(e.entries)) {
            ...
            return (
                I.forEachEntry(e, function (e, r) {
                    t(
                        (function (e) {
                            return I.matchAll(/\w+|\[(\w*)]/g, e).map(function (
                                e
                            ) {
                                return "[]" === e[0] ? "" : e[1] || e[0];
                            });
            ...
            r(
                        ...
                        value: function (e) {
                            ...
                            return (
                                I.forEach(this, function (r, o) {
                                    var i = I.findKey(n, o);
                                    if (i)
                                        return (t[i] = fe(r)), void delete t[o];
                                    var a = e
                                        ? (function (e) {
                                              return e
                                                  .trim()
                ...
                [
                    ...
                    },
                    {
                        key: "accessor",
                        value: function (e) {
                            var t = (this[ue] = this[ue] = { accessors: {} })
                                    .accessors,
                                n = this.prototype;
                            function r(e) {
                                var r = ce(e);
                ...
                return new Promise(function (t, n) {
                    ...
                    I.isFormData(o) &&
                        (ne.isStandardBrowserEnv ||
                            ne.isStandardBrowserWebWorkerEnv) &&
                        i.setContentType(!1);
    ...
    var Oe = function (e) {
        for (
            ...
            o < r &&
            ((t = e[o]), !(n = I.isString(t) ? Ee[t.toLowerCase()] : t));
            o++
        );
        if (!n) {
            if (!1 === n)
    ...
    Ne.transitional = function (e, t, n) {
        function r(e, t) {
            return (
                "[Axios v1.3.5] Transitional option '" +
                e +
                "'" +
                t +
                (n ? ". " + n : "")
                        ...
                        value: function (e, t) {
                            ...
                            void 0 !== o &&
                                Ce.assertOptions(
                                    o,
                                    {
                                        silentJSONParsing: Pe.transitional(
                                            Pe.boolean
                                        ),
                                        forcedJSONParsing: Pe.transitional(
                                            Pe.boolean
                                        ),
                                        clarifyTimeoutError: Pe.transitional(
                                            Pe.boolean
                                        ),
                                    },
                                    !1
