          ...
          @include("layouts.messages")
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                <a href="/admin/counties/create" class="btn btn-primary"> <i class="fa fa-plus-circle"></i> Create New</a>
                </h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                @forelse ($counties as $key => $county )
                  <tr>
                    <td>{{ $key + 1 }}</td>
                    <td>{{ $county->name }}</td>
                    ...
                    @endif</td>
                    <td>
                        <a href="/admin/counties/{{ $county -> id }}/edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                    </td>
                  </tr>
                  @empty
