...
@section("seo")
<title>Record Users Deduction| {{config("app.name")}} </title>
@endsection
...
<div class="row mb-2">
<div class="col-sm-6">
<h1>Record Users Deduction</h1>
</div>
<div class="col-sm-6">
<ol class="breadcrumb float-sm-right">
<li class="breadcrumb-item"><a href="#">Home</a></li>
<li class="breadcrumb-item active">Record Deduction</li>
</ol>
</div>
</div>
</div><!-- /.container-fluid -->
...
<form class="mt-3"  autocomplete="off" novalidate="novalidate" method="post" action="/admin/user_deductions/create">
@csrf
...
<input type="text"   name="deduction_name"   value="{{old("deduction_name") }}" placeholder="Deduction Name" class="form-control @error('deduction_name') is-invalid @enderror" />
