...
@section("seo")
<title>Create DepartMent| {{config("app.name")}}</title>
@endsection
@section("styles")
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Create Department Form</h3>
              </div>
              <!-- /.card-header -->

            @include("layouts.messages")

        <form class="mt-3" method="POST" action="/admin/departments/create" autocomplete="off">
