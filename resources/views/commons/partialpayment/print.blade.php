...
<head>
  ...
  <title>{{ $payment->user->name }} Partial Payment | Kadesea Agency</title>
        ...
        @include("layouts.messages")
            ...
            <div class="col-12">
                 ...
                 <strong>
                  ...
                  <p><b>Invoice</b>
                    INV-{{ str_pad ( $payment->billing_id , 5, "0", STR_PAD_LEFT) }}
                  </p>
                  <p><b>Amount </b> Ksh. {{ $payment->total_fees }}</p>
                  ...
                  <div class="col mb-3">
                   <div class="table-responsive">
                    <table class="table no-border">
                      ...
                      <tr>
                        <th>Terms </th>
                        <td><p class="text-uppercase">Net {{ $payment->net_days }}</p></td>
                      </tr>
                       <tr>
                        <th>Due Date</th>
                        <td><p class="text-uppercase">{{ $payment->due_date }}</p></td>
                      </tr>
                    </table>
                  </div>
                  ...
                  <table class="table table-striped">
                    ...
                    <tr>
                     ...
                     <td>{{ $payment->course->title ?? "" }}</td>
                      ...
                      <td>{{ number_format($payment->total_fees,2) ?? "" }}</td>
                      <td>{{ number_format($payment->total_fees,2) ?? "" }}</td>
                    </tr>
                  ...
                  <div class="table-responsive">
                    <table class="table no-border">
                      <tr>
                        ...
                        <td>Ksh. {{ number_format($payment->total_fees,2)}}</td>
                      </tr>
                      ...
                      <tr>
                        <th>Balance</th>
                        <td>Ksh. {{ number_format($payment->balance,2)}}</td>
                      </tr>
